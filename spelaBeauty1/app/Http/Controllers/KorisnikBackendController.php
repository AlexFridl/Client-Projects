...
class KorisnikBackendController extends BackendController
{
    public function adminPanel_korisnici(){
        try{
            ...
            $this->data['korisnici'] = Korisnik::with('uloga')->paginate(6);
    ...
    {
        try{
            $this->data['korisnik'] = Korisnik::with('uloga')->where('id_korisnik',$id_korisnik)->first();
            $this->data['uloga'] = Uloga::all();
    ...
    public function doAdminPanel_korisnici_update($id_korisnik, KorisnikRequest $request){
